...
import { getArticlesAPI } from "../redux/actions/actions-index.js";
  ...
  return (
    <Container>
      ...
      {props.articles.length === 0 ? (
        ...
        <Content>
          {props.loading && <img src="/images/loader.svg" alt="loading-icon" loading="lazy" />}
          {props.articles.length > 0 &&
            props.articles.map((article, index) => (
              <ArticlePost key={index} props={article} />
            ))}
        </Content>
      )}
